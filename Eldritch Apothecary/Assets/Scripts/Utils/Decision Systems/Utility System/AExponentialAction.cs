...
/// </summary>
public abstract class AExponentialAction<TController> : AAction<Receptionist, float> where TController : ABehaviourController<TController>
{
    bool _inverted;

    protected AExponentialAction(string name, UtilitySystem<Receptionist> utilitySystem, bool inverted = false)
